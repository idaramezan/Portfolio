...
import { setAnalyticsConsent, trackAnalytics } from "@/lib/analytics";
        ...
        >
          ...
          <div className="analytics-sheet__inner">
            <div className="flex gap-3 pr-10">
              <span className="analytics-sheet__icon">
              ...
              <div>
                ...
                >
                  Analytics helps Aida understand which pages and studio
                  projects visitors find useful. A random first-party identifier
                  and approximate location may be used. Raw IP addresses are not
                  stored.
                </p>
                {showDetails && (
            ...
            <div className="analytics-sheet__actions">
              ...
              <button
                className="analytics-sheet__decline"
              ...
              <button
                type="button"
                className="analytics-sheet__manage"
