...
const TR: Record<string, string> = {
  ...
  "Art from Aida’s Istanbul studio, delivered across Türkiye.":
    "Aida’nın İstanbul stüdyosundan sanat eserleri, Türkiye’nin her yerine teslim.",
  ...
  "Original paintings available internationally":
    "Uluslararası koleksiyona açık orijinal resimler",
  "One-of-a-kind oil pastel works, signed by Aida and available only once.":
    "Aida imzalı, tek ve benzersiz yağlı pastel eserler.",
  ...
  "Signed prints, T-shirts, mugs and stickers featuring Aida’s studio artwork.":
    "Aida’nın stüdyo eserlerini taşıyan imzalı baskılar, tişörtler, kupalar ve çıkartmalar.",
  ...
  "International shipping is not included.":
    "Uluslararası kargo dahil değildir.",
  ...
  "A new Mystery Mail is coming to the studio.":
    "Stüdyoya yeni bir Gizemli Posta geliyor.",
  ...
  "Discover one of a kind paintings, signed art prints and small themed art packages created by Istanbul artist Aida Ramezani.":
    "İstanbullu sanatçı Aida Ramezani’nin benzersiz resimlerini, imzalı sanat baskılarını ve temalı küçük sanat paketlerini keşfedin.",
  ...
  "Shopping in Türkiye": "Türkiye’de alışveriş",
  "Shopping internationally": "Uluslararası alışveriş",
  "Switch to international": "Uluslararası mağazaya geç",
  "Switch to Türkiye": "Türkiye mağazasına geç",
  ...
  "Made by Aida Ramezani in Istanbul":
    "Aida Ramezani tarafından İstanbul’da üretildi",
  ...
  "The goal is to make collecting art feel personal, approachable and connected to the artist who created it.":
    "Amaç, sanat koleksiyonculuğunu kişisel, ulaşılabilir ve eseri yaratan sanatçıyla bağlantılı kılmaktır.",
  ...
  "No online payment is collected through this website.":
    "Bu web sitesi üzerinden çevrimiçi ödeme alınmaz.",
  Social: "Sosyal medya",
  ...
  "Self-taught, instinct-led.":
    "Kendi kendini yetiştirmiş, içgüdüleriyle yönlenen.",
  ...
  "Collect Art Directly from Aida":
    "Sanatı doğrudan Aida’dan koleksiyonunuza katın",
  ...
  "Choose the path that fits where you live.":
    "Yaşadığınız yere uygun yolu seçin.",
  "Collect directly within Türkiye": "Türkiye içinde doğrudan koleksiyon yapın",
  "International originals": "Uluslararası orijinaller",
  "Collect an original internationally":
    "Uluslararası bir orijinal eser edinin",
  "International prints": "Uluslararası baskılar",
  "Order prints through Fourthwall":
    "Baskıları Fourthwall üzerinden sipariş edin",
  "Browse this shop": "Bu mağazaya göz at",
  "Painted live. Watched by thousands.":
    "Canlı yayında resmedildi. Binlerce kişi izledi.",
  ...
  "Yes. Shipping is included for orders delivered within Türkiye unless a product explicitly states otherwise.":
    "Evet. Bir üründe aksi açıkça belirtilmedikçe Türkiye içindeki siparişlerde kargo fiyata dahildir.",
  ...
  "Add the pieces you want to your basket, then continue to WhatsApp. Your selected products, options and total are included automatically.":
    "İstediğiniz eserleri sepetinize ekleyip WhatsApp’a devam edin. Seçtiğiniz ürünler, seçenekler ve toplam tutar mesaja otomatik eklenir.",
  "Can I order more than one product?":
    "Birden fazla ürün sipariş edebilir miyim?",
  "Yes. You can combine available originals, prints, goods and Mystery Mail items in one basket.":
    "Evet. Mevcut orijinalleri, baskıları, ürünleri ve Gizemli Posta’yı tek sepette birleştirebilirsiniz.",
  "Are original paintings one of a kind?":
    "Orijinal resimler tek ve benzersiz mi?",
  "Yes. Each original painting is unique and cannot be ordered again once sold.":
    "Evet. Her orijinal resim benzersizdir ve satıldıktan sonra tekrar sipariş edilemez.",
  "Can prints be ordered framed?":
    "Baskıları çerçeveli sipariş edebilir miyim?",
  ...
  "Can I order internationally from this page?":
    "Bu sayfadan uluslararası sipariş verebilir miyim?",
  "Can original paintings be shipped internationally?":
    "Orijinal resimler yurt dışına gönderilebilir mi?",
  "Is international shipping included in the original’s price?":
    "Uluslararası kargo orijinal eserin fiyatına dahil mi?",
  "How do I order an original painting?":
    "Orijinal bir resmi nasıl sipariş ederim?",
  "Where do I buy international prints and goods?":
    "Uluslararası baskı ve ürünleri nereden satın alabilirim?",
  "Why do Fourthwall products open on another website?":
    "Fourthwall ürünleri neden başka bir sitede açılıyor?",
  "Can I add a Fourthwall item and an original to the same basket?":
    "Fourthwall ürünü ile orijinal eseri aynı sepete ekleyebilir miyim?",
  "Does Mystery Mail ship internationally?":
    "Gizemli Posta yurt dışına gönderiliyor mu?",
  ...
  "Is the postcard available separately?":
    "Sanat kartı ayrı olarak satılıyor mu?",
  "No. The art postcard is created only for that Mystery Mail edition.":
    "Hayır. Sanat kartı yalnızca ilgili Gizemli Posta edisyonu için hazırlanır.",
  ...
  "Aida Ramezani is a self-taught oil pastel artist based in Istanbul. Her work is rooted in texture, instinct and the physical act of making.":
    "Aida Ramezani, İstanbul’da yaşayan ve kendi kendini yetiştirmiş bir yağlı pastel sanatçısıdır. Eserleri dokuya, içgüdüye ve üretmenin fiziksel sürecine dayanır.",
  ...
  "Aida began painting without formal training, drawn to the immediacy and sensitivity of oil pastel.":
    "Aida, yağlı pastelin doğrudanlığına ve duyarlılığına ilgi duyarak resmi resmi bir eğitim almadan öğrenmeye başladı.",
  "She works intuitively, allowing each layer, mark and texture to shape the final piece. Rather than hiding imperfections, she keeps them as part of the artwork’s history and character.":
    "Sezgisel çalışır; her katmanın, izin ve dokunun son eseri şekillendirmesine izin verir. Kusurları gizlemek yerine onları eserin geçmişinin ve karakterinin bir parçası olarak korur.",
  "Aida creates original oil pastel paintings on textured paper using simple studio tools.":
    "Aida, sade stüdyo araçlarıyla dokulu kağıt üzerine orijinal yağlı pastel resimler üretir.",
  "Aida creates art that feels personal, lived-in and quietly precious.":
    "Aida kişisel, yaşanmış ve sakin biçimde değerli hissettiren sanat eserleri üretir.",
  "Each work begins with oil pastel and a blank sheet of paper. Aida paints directly, responding to colour, texture and movement as the image develops.":
    "Her eser yağlı pastel ve boş bir kağıtla başlar. Aida, görüntü geliştikçe renge, dokuya ve harekete doğrudan karşılık vererek resmeder.",
  ...
  "A few pieces from the studio, ready to discuss.":
    "Stüdyodan seçtiğiniz eserler, birlikte görüşmeye hazır.",
  "Every collection is confirmed personally. Review your selection, then continue with Aida on WhatsApp to confirm availability, payment, and delivery.":
    "Her koleksiyon kişisel olarak onaylanır. Seçiminizi inceleyin, ardından stok, ödeme ve teslimatı onaylamak için WhatsApp üzerinden Aida ile devam edin.",
  ...
  "International shipping: Calculated separately":
    "Uluslararası kargo: Ayrıca hesaplanır",
  "Continue directly with the artist.": "Doğrudan sanatçıyla devam edin.",
  "Aida personally confirms every selection, answers questions, and arranges payment and delivery with you.":
    "Aida her seçimi kişisel olarak onaylar, sorularınızı yanıtlar ve ödeme ile teslimatı sizinle birlikte düzenler.",
  ...
  "Your basket does not reserve artwork or change inventory.":
    "Sepetiniz eseri ayırmaz veya stok durumunu değiştirmez.",
  "Every collection is confirmed personally with Aida before purchase.":
    "Her koleksiyon satın almadan önce Aida ile kişisel olarak onaylanır.",
  Artwork: "Eser",
  Items: "Ürünler",
