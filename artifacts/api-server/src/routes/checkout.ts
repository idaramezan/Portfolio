...
async function ensureSchema() {
  ...
  await pool.query(`ALTER TABLE event_applications ADD COLUMN IF NOT EXISTS registration_status TEXT NOT NULL DEFAULT 'pending', ADD COLUMN IF NOT EXISTS attendance_status TEXT NOT NULL DEFAULT 'unknown', ADD COLUMN IF NOT EXISTS gender TEXT, ADD COLUMN IF NOT EXISTS attended_at TIMESTAMPTZ`);
  await pool.query(`ALTER TABLE event_banner_config ADD COLUMN IF NOT EXISTS booking_open_at TIMESTAMPTZ, ADD COLUMN IF NOT EXISTS booking_close_at TIMESTAMPTZ`);
}
