...
assert.ok(home.includes('home-turkiye-flag.jpg') && home.includes('home-international-flags.jpg') && home.includes('alt="Turkish flag"') && home.includes('alt="International flags"'), "shop destination cards must restore the established regional flag images");
assert.ok(css.includes("background: var(--blue-light) !important") && css.includes(".public-footer") && css.includes("background: var(--blue-light) !important"), "Newsletter and footer must use the light-blue identity");
