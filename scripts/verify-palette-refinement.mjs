...
assert.ok(home.includes('title: "Originals"') && !home.includes("<p>{item.copy}</p>") && css.includes("[data-public-site] .button-primary"), "category cards must be concise and public pink buttons must share the playful treatment");
