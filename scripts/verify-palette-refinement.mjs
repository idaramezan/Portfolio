...
assert.ok(home.includes("Local shop") && home.includes("Worldwide") && home.includes("home-market-action__content") && home.includes("home-category-link__content") && home.includes("originalsCoverImage") && home.includes("printsCoverImage") && home.includes("studioMailCoverImage") && !home.includes("hasActiveShoppingRegionPreference"), "homepage must use image-led destination and category navigation once");
