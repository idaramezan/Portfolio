...
assert.ok(!css.includes("max-height: 210px") && !css.includes("home-category-link--paper > span:not") && css.includes(".home-event-announcement::before"), "legacy mobile overrides must not clip the event or hide category content");
