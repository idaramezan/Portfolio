...
assert.ok(email.includes("#f4cfda") && email.includes("#3b2935") && newsletter.includes("font-family:Arial Black") && newsletter.includes("@media only screen and (max-width:620px)"), "transactional and Newsletter email rendering must share the revised system responsively");
