...
assert.ok(landing.includes("<ManagedProductCard") && landing.includes("<TurkeyProductDialog") && landing.includes("MessageCircle"), "catalogue must reuse product, option, basket, and WhatsApp flows");
